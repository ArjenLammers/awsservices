...
public class EncryptString extends CustomJavaAction<java.lang.String>
{
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if(isLegacyAlgorithm(this.prefix))
			throw new MendixRuntimeException(
					String.format("Prefix '%s' is no longer supported "
						+ "for encryption. Please use '%s'", LEGACY_PREFIX, NEW_PREFIX));
	...
	private final String NEW_PREFIX = "{AES2}";
	
	private boolean isLegacyAlgorithm(String text) {
		return text.trim().equals(LEGACY_PREFIX);
	}
